			...
			this.path = function(ctx) {
				...
				while (!pp.isEnd()) {
					...
					case 'M':
						...
						if (ctx != null) {
						    ctx.moveTo(p.x, p.y);
						    $('#print').append("ctx.moveTo("+p.x+","+p.y+");\n");
						}
						pp.start = pp.current;
						while (!pp.isCommandOrEnd()) {
							...
							if (ctx != null) {
							    ctx.lineTo(p.x, p.y);
							    $('#print').append("ctx.lineTo("+p.x+","+p.y+");\n");
							}
						}
						break;
					case 'L':
					...
					case 'C':
						while (!pp.isCommandOrEnd()) {
							...
							if (ctx != null) {
							    ...
							    $('#print').append("ctx.bezierCurveTo("+p1.x+", "+p1.y+", "+cntrl.x+", "+cntrl.y+", "+cp.x+", "+cp.y+");\n");
